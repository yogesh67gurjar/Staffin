...
public class ShowExpansesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(ShowExpansesActivity.this);
...
//                        images.add(singleUnit.get(0).getImage1());
//                    }
//                    if (!singleUnit.get(0).getImage2().substring(singleUnit.get(0).getImage2().lastIndexOf("/")).equals("0")) {
//                        images.add(singleUnit.get(0).getImage2());
//                    }
//                    if (!singleUnit.get(0).getImage3().substring(singleUnit.get(0).getImage3().lastIndexOf("/")).equals("0")) {
//                        images.add(singleUnit.get(0).getImage3());
//                    }
//                    if (!singleUnit.get(0).getImage4().substring(singleUnit.get(0).getImage4().lastIndexOf("/")).equals("0")) {
//                        images.add(singleUnit.get(0).getImage4());
//                    }
//                    if (!singleUnit.get(0).getImage5().substring(singleUnit.get(0).getImage5().lastIndexOf("/")).equals("0")) {
//                        images.add(singleUnit.get(0).getImage5());
//                    }
//                    if (!singleUnit.get(0).getImage6().substring(singleUnit.get(0).getImage6().lastIndexOf("/")).equals("0")) {
//                        images.add(singleUnit.get(0).getImage6());
//                    }
//                    if (!singleUnit.get(0).getImage7().substring(singleUnit.get(0).getImage7().lastIndexOf("/")).equals("0")) {
//                        images.add(singleUnit.get(0).getImage7());
//                    }
//                    if (!singleUnit.get(0).getImage8().substring(singleUnit.get(0).getImage8().lastIndexOf("/")).equals("0")) {
//                        images.add(singleUnit.get(0).getImage8());
//                    }
//                    if (!singleUnit.get(0).getImage9().substring(singleUnit.get(0).getImage9().lastIndexOf("/")).equals("0")) {
//                        images.add(singleUnit.get(0).getImage9());
//                    }
//                    if (!singleUnit.get(0).getImage10().substring(singleUnit.get(0).getImage10().lastIndexOf("/")).equals("0")) {
//                        images.add(singleUnit.get(0).getImage10());
//                    }
//
//                    for (String i : images) {
...
//                    }
                    ...
                    binding.showRecyclerView.setLayoutManager(new LinearLayoutManager(ShowExpansesActivity.this));

...
//                int day = cal.get(Calendar.DATE);
    ...
    private void initializeCalendar() {
        ...
        Event ev4 = new Event(Color.GREEN, milliTime, "Teachers' Professional Day");
        ...
        Event ev5 = new Event(Color.GREEN, milliTime, "Teachers' Professional Day");
        ...
        Event ev6 = new Event(Color.GREEN, milliTime, "Teachers' Professional Day");
        ...
        Event ev7 = new Event(Color.GREEN, milliTime, "Teachers' Professional Day");
...
//        Event ev8 = new Event(Color.GREEN, milliTime, "Teachers' Professional Day");

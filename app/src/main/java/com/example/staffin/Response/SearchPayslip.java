...
public class SearchPayslip {
    ...
    public class PayslipDetail {
        ...
        @Expose
        private List<SearchPayslip.PayslipDetail.EmployeeId> employeeId;
        ...
        public List<SearchPayslip.PayslipDetail.EmployeeId> getEmployeeId() {
            return employeeId;
        }

        public void setEmployeeId(List<SearchPayslip.PayslipDetail.EmployeeId> employeeId) {
